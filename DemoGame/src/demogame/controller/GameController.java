...
//     private final AtomicBoolean isGameRunning; // track game running status
...
//         this.userId = userId;
//         this.currentScore = 0; //on top left it ensure score is 0 while starting
//         this.isGameRunning = new AtomicBoolean(false);
//         this.scoreDao = new ScoreDao();
//     }
// // link banana controller and listens for score updates
...
// // for loading screen before starting game
...
//         }
//     }
// // database ma every 30 seconds ma score updates garcha instead waiting for complete out
...
//             }
//         }, 30_000, 30_000); // Save every 30 seconds
//     }
